...
inputFile = LOAD 'hdfs:///user/projects/episode6.txt' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
STORE namesOrdered INTO 'hdfs:///user/projects/episode6output' USING PigStorage('\t');
