...
inputFile = LOAD 'hdfs:///user/projects/episode4.txt' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
STORE namesOrdered INTO 'hdfs:///user/projects/episode4output' USING PigStorage('\t');
